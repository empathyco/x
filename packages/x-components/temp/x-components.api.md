...
// @public
export class MultiColumnMaxWidthLayout extends Vue_2 {
...
// @public
export const setUrlExtraParams: Wire<Dictionary<unknown>>;
...
// @public
export class SingleColumnLayout extends Vue_2 {
    protected asideAnimation: Vue_2;
    protected devMode: boolean;
    // @internal
    protected hasContent(...slotNames: string[]): boolean;
...
// @public
export const updateStoreFromUrl: Wire<UrlParams>;
...
export const urlEmitters: {
    PushableUrlStateChanged: {
        ...
        filter: typeof isPushableParams;
    };
    ReplaceableUrlStateChanged: {
        selector: (_: UrlState, getters: Returns<GettersTree<UrlState, UrlGetters>>) => UrlParams;
        filter: (newValues: UrlParams, oldValues: UrlParams) => boolean;
    };
};
...
export const urlWiring: {
    ...
    ParamsLoadedFromUrl: {
        updateStoreFromUrl: Wire<UrlParams>;
    };
    SelectedRelatedTagsChanged: {
    ...
    ExtraParamsProvided: {
        setUrlExtraParams: Wire<Dictionary<unknown>>;
    };
    UserChangedExtraParams: {
        setUrlExtraParams: Wire<Dictionary<unknown>>;
    };
...
// @public
export interface XEventsTypes extends DeviceXEvents, EmpathizeXEvents, ExtraParamsXEvents, FacetsXEvents, HistoryQueriesXEvents, IdentifierResultsXEvents, NextQueriesXEvents, PopularSearchesXEvents, QuerySuggestionsXEvents, RecommendationsXEvents, RelatedTagsXEvents, SearchXEvents, SearchBoxXEvents, UrlXEvents {
...
export class XPlugin implements PluginObject<XPluginOptions> {
    ...
    // @internal
    customizeXModule({ name, wiring, storeModule, storeEmitters, ...restXModule }: AnyXModule): AnyXModule;
    // @internal
...
// src/x-modules/url/store/emitters.ts:36:1 - (ae-forgotten-export) The symbol "isPushableParams" needs to be exported by the entry point index.d.ts
