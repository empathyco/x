...
import BasePriceFilterLabel from '../../../src/components/filters/labels/base-price-filter-label.vue'
import ChevronDown from '../../../src/components/icons/chevron-down.vue'
import BaseHeaderTogglePanel from '../../../src/components/panels/base-header-toggle-panel.vue'
...
import EditableNumberPriceRangeFilter from '../../../src/x-modules/facets/components/filters/editable-number-range-filter.vue'
import HierarchicalFilter from '../../../src/x-modules/facets/components/filters/hierarchical-filter.vue'
import SimpleFilter from '../../../src/x-modules/facets/components/filters/simple-filter.vue'
import ExcludeFiltersWithNoResults from '../../../src/x-modules/facets/components/lists/exclude-filters-with-no-results.vue'
import FiltersList from '../../../src/x-modules/facets/components/lists/filters-list.vue'
import FiltersSearch from '../../../src/x-modules/facets/components/lists/filters-search.vue'
import SelectedFiltersList from '../../../src/x-modules/facets/components/lists/selected-filters-list.vue'
import SelectedFilters from '../../../src/x-modules/facets/components/lists/selected-filters.vue'
import SlicedFilters from '../../../src/x-modules/facets/components/lists/sliced-filters.vue'
import SortedFilters from '../../../src/x-modules/facets/components/lists/sorted-filters.vue'
