...
| setSnippetConfig | - [Snippet Configuration](#snippet-configuration) - The Initialisation options | Changes the options and all components react to the changes. Helps to change, language, for instance, to respond to user interactions without reloading the page. |
