...
export interface RelatedTagsXEvents {
   ...
   * * Payload: The new {@link @empathyco/x-types-old#RelatedTag | related tags}.
   */
   ...
   * * Payload: The new {@link @empathyco/x-types-old#RelatedTag | selected related tags}.
   */
  SelectedRelatedTagsChanged: RelatedTag[];
  /**
   * User deselected a related tag
   * * Payload: The {@link @empathyco/x-types-old#RelatedTag | related tag} that the user
   * deselected.
   */
