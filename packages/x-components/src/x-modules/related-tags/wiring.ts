...
/**
 * Sets the related tags state `query` but this query comes from a selected query preview.
 *
 * @public
 */
export const setRelatedTagsQueryFromQueryPreview = wireCommit(
  'setQuery',
...
/**
 * Sets the related tags state `params` but these are provided from the selected query preview.
 *
 * @public
 */
...
export const relatedTagsWiring = createWiring({
  ...
  UserAcceptedAQueryPreview: {
    setRelatedTagsQueryFromQueryPreview,
    clearSelectedRelatedTags,
