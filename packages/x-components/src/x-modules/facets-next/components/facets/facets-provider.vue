<script lang="ts">
  ...
  export default class FacetsProvider extends Vue {
     ...
     * This is necessary to handle the {@link FacetsXEvents.UserChangedSelectedNextFilters} event.
     *
     * @internal
     */
