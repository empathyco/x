...
<script lang="ts">
   ...
   * {@link @empathyco/x-types-old#BooleanFilter | BooleanFilter} as prop and renders a button,
   * which on clicked emits the {@link FacetsXEvents.UserClickedFacetAllFilter} event. By default
