...
/**
 * Sets the semantic queries state `params` but these are provided from the selected query preview.
 *
 * @public
 */
export const setSemanticQueriesExtraParamsFromQueryPreviewWire = wireCommit(
  'setParams',
...
export const semanticQueriesWiring = createWiring({
  ...
  UserAcceptedAQueryPreview: {
    clearQueryWire,
    setSemanticQueriesExtraParamsFromQueryPreviewWire
  }
});
