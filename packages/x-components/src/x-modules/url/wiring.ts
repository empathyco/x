...
/**
 * Sets the url state `params` but these are provided from the selected query preview.
 *
 * @public
 */
export const setUrlParamsFromQueryPreview = wireCommit(
  'setParams',
