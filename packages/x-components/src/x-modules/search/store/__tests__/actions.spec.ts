...
describe('testing search module actions', () => {
  ...
  describe('saveSearchResponse', () => {
    it('saves the search response in the search state', async () => {
      await store.dispatch('saveSearchResponse', {
        ...searchResponseStub,
    ...
    it('saves default values of optional or undefined response properties in the search state', async () => {
      await store.dispatch('saveSearchResponse', {
        ...searchResponseStub,
        partialResults: undefined,
        redirections: undefined,
