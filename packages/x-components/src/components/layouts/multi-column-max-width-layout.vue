<template>
  ...
  >
    <header class="x-layout__header">
      <div v-if="hasContent('header-start')" class="x-flex x-layout__header-start">
      ...
      <div v-if="hasContent('header-middle')" class="x-flex x-layout__header-middle">
      ...
      <div v-if="hasContent('header-end')" class="x-flex x-layout__header-end">
    ...
    <section v-if="hasContent('toolbar-aside', 'toolbar-body')" class="x-layout__toolbar">
      <aside class="x-flex x-layout__toolbar-aside">
      ...
      <div class="x-flex x-layout__toolbar-body">
