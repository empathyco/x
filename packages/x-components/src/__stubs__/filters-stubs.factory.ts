...
/**
 * Creates {@link @empathyco/x-types-old#SimpleFilter | SimpleFilter} stub.
 *
...
/**
 * Creates {@link @empathyco/x-types-old#NumberRangeFilter | NumberRangeFilter} stub.
 *
 * @param filter - A partial filter to override certain properties. Useful for testing.
...
/**
 * Creates {@link @empathyco/x-types-old#HierarchicalFilter | HierarchicalFilter} stub.
 *
 * @param filter - A partial filter to override certain properties. Useful for testing.
...
/**
 * Creates a {@link @empathyco/x-types-old#Filter | Filter} with the provided `modelName`, `facetId`
 * and `label`.
 *
 ...
 * and `label` fields.
 *
 * @returns A {@link @empathyco/x-types-old#Filter | Filter}.
 */
...
/**
 * Creates a {@link @empathyco/x-types-old#EditableNumberRangeFilter | EditableNumberRangeFilter}
 ...
 *
 * @returns An {@link @empathyco/x-types-old#EditableNumberRangeFilter | EditableNumberRangeFilter}.
 */
...
/**
 * Creates a {@link @empathyco/x-types-old#SimpleFilter | SimpleFilter} with the `facetId`, `label`
 * and `selected` value.
 *
 * @param facetId - The facet id.
 * @param label - The filter label. Used to set the `id` (combined with the facetId)
 ...
 *
 * @returns An {@link @empathyco/x-types-old#SimpleFilter | SimpleFilter}.
 */
...
/**
 * Creates a {@link @empathyco/x-types-old#HierarchicalFilter | HierarchicalFilter}.
 *
 * @param facetId - The facet id.
 * @param label - The filter label. Used to set the `id` (combined with the facetId)
 * and `label` fields.
 * @param selected - The selected value, false by default.
 * @returns An {@link @empathyco/x-types-old#HierarchicalFilter | HierarchicalFilter}.
 */
...
/**
 *
 * Creates a {@link @empathyco/x-types-old#NumberRangeFilter | NumberRangeFilter}.
 *
 * @param facetId - The facet id.
 * @param range - The `min` and `max` values of the filter.
 * @param selected - The selected value, false by default.
 * @returns An {@link @empathyco/x-types-old#NumberRangeFilter | NumberRangeFilter}.
 */
