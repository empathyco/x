...
describe('testing wires factory', () => {
  ...
  describe('testing mutations wires factory', () => {
    ...
    it(`${wireCommit.name} allows creating wires that commit a mutation with the observable payload`, () => {
    ...
    it(`${wireCommit.name} allows creating wires that commit a mutation with a static payload`, () => {
  ...
  describe('testing actions wires factory', () => {
    ...
    it(`${wireDispatch.name} allows creating wires that dispatch an action with a static payload`, () => {
