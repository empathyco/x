<template>
  <section class="x-list x-padding--07 x-list--gap-05 x-list--justify-start x-list--align-start">
    ...
    <article class="x-list x-list--wrap x-list--gap-06 x-list--align-start">
      ...
      <ul class="x-list x-list--vertical x-list--padding-06 x-list--padding-right x-list-show-case">
        <li></li>
        <li></li>
        <li></li>
      </ul>
      ...
      <ul class="x-list x-list--vertical x-list--padding-06 x-list--padding-left x-list-show-case">
        <li></li>
        <li></li>
        <li></li>
      </ul>
    ...
    <article class="x-list x-list--wrap x-list--gap-06 x-list--align-start">
      ...
      <ul class="x-list x-list--horizontal x-list--padding-06 x-list--padding-top x-list-show-case">
        <li></li>
        <li></li>
        <li></li>
      </ul>
      <ul
        class="x-list x-list--horizontal x-list--padding-06 x-list--padding-right x-list-show-case"
      >
        <li></li>
        <li></li>
        <li></li>
      ...
      <ul
        class="x-list x-list--horizontal x-list--padding-06 x-list--padding-bottom x-list-show-case"
      >
        <li></li>
        <li></li>
        <li></li>
    ...
    <article class="x-list x-list--wrap x-list--gap-06 x-list--align-start x-list-alignment">
      ...
      <div class="x-list x-list--gap-03 x-list-alignment-vertical">
        ...
        <ul
          class="x-list x-list--vertical x-list--justify-start x-list--align-start x-list-show-case"
        >
          <li></li>
          <li></li>
          <li></li>
        ...
        <ul class="x-list x-list--vertical x-list--justify-end x-list--align-end x-list-show-case">
          <li></li>
          <li></li>
          <li></li>
        </ul>
...
<script lang="ts">
  ...
  @Component
  export default class DesignSystemList extends Vue {}
</script>
