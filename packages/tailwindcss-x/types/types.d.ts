 ...
 * @internal
 */
declare type CSSClassSelector = `.${string}`;
/**
 ...
 * @internal
 */
declare type CSSNestedSelector = `&${string}`;
/**
 ...
 * @public
 */
export declare type DynamicStylesOptions = Dictionary<{
 ...
 * @public
 */
export declare type TailwindHelpers = Parameters<TailwindPluginFn>[0];
/**
